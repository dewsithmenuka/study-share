...
class ProfileController extends Controller
{
    public function index()
    {
        ...
        $stats = [
            ...
            'average_rating'     => round(ResourceFile::where('user_id', $user->id)->with('ratings')->get()->flatMap->ratings->avg('score'), 1),
        ];

        $completionFields = ['name', 'email', 'username', 'avatar', 'student_id', 'degree_program', 'semester', 'bio', 'phone'];
